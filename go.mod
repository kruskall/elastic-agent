...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/k8sobjectsreceiver v0.107.0
	...
	go.opentelemetry.io/collector/extension/memorylimiterextension v0.107.0
